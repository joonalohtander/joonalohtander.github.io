...
library(reticulate)
use_python("C:\\Users\\joona\\AppData\\Local\\Microsoft\\WindowsApps\\python3.9.exe")
```

## Digitally Averaging Time Magazines Covers From 2021

In this project I will take the average of every Time magazines cover from last year. By taking the average I mean taking the average RGB-values for all the pixels.
