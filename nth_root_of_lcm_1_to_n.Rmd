...
I saw somewhere this interesting property: the N:th root of the least common multiple of an integer vector from 1 to N approaches the Euler's number when N approaches infinity:
